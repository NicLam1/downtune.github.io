<template>
    ...
    <body>
        ...
        <div id="app">
            <div class="background" :class="{ 'fade-out': isFadingOut, 'fade-in': !isFadingOut }"
                :style="{ backgroundImage: `url(${currentBackground})` }"></div> <!-- New div for background images -->
            ...
            <div class="login_wrap">
                <div class="ring" id="hoverCircle" @mouseenter="changeBackground('/img2/gig2.jpg')"
                    @mouseleave="changeBackground('/img2/gig.jpg')">
                    <i></i>
                    <i></i>
                    <i></i>
                    ...
                    <div class="container">
                        ...
                        <h2 class="text-center text-dark fw-bold mb-4">Sign in to your listener account</h2>
                        ...
                        <p class="text-center mt-3">
                            ...
                            <router-link to="/register/user" class="text-primary">Sign up</router-link>
                        </p>
